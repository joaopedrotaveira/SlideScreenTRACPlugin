...
public class JSONRPC2Request extends JSONRPC2Message {
	...
	public static JSONRPC2Request parse(final String jsonString, final boolean preserveOrder, final boolean noStrict)
		...
		if (params == null)
			...
			return new JSONRPC2Request((String)method, (List<Object>)params, id);
		else if (params instanceof Map<?,?>)
			return new JSONRPC2Request((String)method, (Map<String,Object>)params, id);
		else
	 ...
	 *               be avoided).
	 */
	public JSONRPC2Request(String method, List<Object> params, Object id) {
	 ...
	 *               be avoided).
	 */
	public JSONRPC2Request(String method, Map<String,Object> params, Object id) {
